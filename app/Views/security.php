...
<main id="js-page-content" role="main" class="page-content mt-3">
  ...
  <?php foreach ($posts as $v): ?>
    ...
    <?php echo \Tamtamchik\SimpleFlash\Flash::display(); ?>

      <form method="post" action=<?php echo "/security_func?id=$user_id"; ?>>
          <div class="row">
              <div class="col-xl-6">
                      ...
                      <div class="panel-container">
                          ...
                          <div class="panel-content">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="password" id="simpleinput" name="password_reset" class="form-control">
                              </div>
